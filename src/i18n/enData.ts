...
const enData: Record<string, string> = {
  /* Газар чөлөөлөлтийн Tuluv төлөв + гүйцэтгэгчийн гарал — Gazar/Dashboard-д
     tr(утга) хэлбэрээр ДИНАМИКААР орчуулагдана (2026-08-24). */
  ...
  "Багц -2": "Package -2",
  "Багц -1": "Package -1",
  "Холбоо дохиолол": "Communications and signalling",
  "Цахилгаан, гэрэлтүүлэг": "Electricity and lighting",
  "Цэвэр бохир усны ажил": "Water and sewerage works",
  "Халаалт агаар сэлгэлт ажил": "Heating and ventilation works",
  "Барилгын ажил": "Construction works",
  "Б5": "B5",
  "Б4": "B4",
  "Б3": "B3",
  "Б2": "B2",
  "Б1": "B1",
  "Дүйцүүлсэн": "Equivalent",
  "АТД": "ATD",
