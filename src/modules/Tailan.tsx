                ...
                return (
                  <>
                    ...
                    <section id="full-1" tabIndex={-1} className={r.section}>
                      ...
                      <p className={r.intro}>
                        {tr('Энэ хэсэгт төслийн цар хүрээ, гүйцэтгэл, санхүүжилтийн долоон гол үзүүлэлтийг нэгтгэв. Гүйцэтгэлийн хоёр өөр хэмжүүрийг ялган үзэх нь зүйтэй: орон сууцны багцуудын жигнэсэн гүйцэтгэл нь багц бүрийн блокийн дундажийг төсвийн жингээр нь нэгтгэсэн дүн бол барилга угсралтын гүйцэтгэл нь бүх блокийн энгийн дундаж. Удирдлагын тайлангийн «Төслийн нийт гүйцэтгэл (6 шатаар)» нь өөр хэмжүүр — зураг төслөөс улсын комисс хүртэлх зургаан үе шатыг жингээр нэгтгэсэн хувь.')}
                      </p>
