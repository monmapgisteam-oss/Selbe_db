...
function TailanFull() {
  ...
  /**
   * Тайлан үүсгэхэд гарсан алдаа — зурвасын доор нэрлэсэн мэдэгдэл болно.
   *
   * ⚠️ `alert()`-ийн ОРОНД. Модаль нь UI-г блоклоод зогсохгүй порталын бусад
   * бүх алдааны хэв маягаас (`Data` → нэрлэсэн мэдэгдэл + «Дахин оролдох»)
   * ганцаараа зөрдөг байв.
   */
    ...
    async (fn: (r: BagtsRow[], d: string, x: ReportExtra) => Promise<void>, what: string, done: string) => {
      ...
      try {
        ...
        /* ⚠️ `alert()` БИШ: тэр нь UI-г блоклодог модаль бөгөөд порталын бусад
           бүх алдаа (`Data`) нэрлэсэн мэдэгдэл + «Дахин оролдох» товчоор
           гардаг тул энд ганцаараа тусдаа хэв маяг байв. Одоо зурвасын доор
           нэрлэсэн мэдэгдэл болж, дахин оролдох боломж нь товчнууд идэвхтэй
           хэвээр үлдсэнээр хангагдана.
           ⚠️ ArcGIS-ийн алдааны УРТ түүхийг хэрэглэгч рүү шидэхгүй — консолд
           бүтнээр нь үлдээж, дэлгэцэнд зөвхөн юу бүтэлгүйтсэнийг хэлнэ. */
        setFail(tr('{0} үүсгэхэд алдаа гарлаа. Дахин оролдоно уу.', what));
      } finally {
        setBusy(false);
      }
    },
                ...
                return (
                  <>
                    ...
                    <section id="full-1" tabIndex={-1} className={r.section}>
                      ...
                      <p className={r.intro}>
                        {tr('Энэ хэсэгт төслийн цар хүрээ, гүйцэтгэл, санхүүжилтийн долоон гол үзүүлэлтийг нэгтгэв. Гүйцэтгэлийн хоёр өөр хэмжүүрийг ялган үзэх нь зүйтэй: орон сууцны багцуудын жигнэсэн гүйцэтгэл нь багц бүрийн блокийн дундажийг төсвийн жингээр нь нэгтгэсэн дүн бол барилга угсралтын гүйцэтгэл нь бүх блокийн энгийн дундаж. Удирдлагын тайлангийн «Төслийн нийт гүйцэтгэл» нь өөр хэмжүүр буюу нэгтгэл гүйцэтгэлийн хүснэгтэд ТЭЗҮ-гээс төсөл хүлээлгэн өгөх хүртэлх үе шатыг төсөлд эзлэх хувиар нь нэгтгэсэн дүн.')}
                      </p>
                      ...
                      <KpiRow items={[
                        ...
                        /* ⚠️ 2026-09-21: ШОШГО ялгав, ТОО ӨӨРЧЛӨГДӨӨГҮЙ. «Төслийн нийт
                           ...
                           тайлан — 6 шатны жигнэсэн; дашбоард — багцаар сарын биет)
                           зэрэг явдаг байсан тул нэр бүр юу болохоо хэлнэ.
                           ⚠️ 2026-09-25: удирдлагын тайлангийнх одоо «Нэгтгэл
                           гүйцэтгэл»-ийн төслийн нийт (унавал 6 шатаар — шошго нь
                           `gdash.progressSrc`-ээр ялгарна). */
                        { label: tr('Орон сууцны гүйцэтгэл (багцаар, төсвийн жинтэй)'), value: pct(x.overall.pct, 2) },
                      ...
                      <ResizableTable storeKey="tailan.tovch" className={r.table}>
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td title={tr('Хяналтын бүх блокийн энгийн дундаж (6-р хэсэг)')}>{tr('Барилга угсралтын гүйцэтгэл (блокийн дундаж)')}</td>
                      ...
                      <p className={r.note}>
                        {tr('Орон сууцны гүйцэтгэл (багцаар, төсвийн жинтэй) нь')} {num(x.overall.rows)} {tr('блокийг багцынх нь төсвийн жингээр тооцсон дүн (3-р хэсэг); барилга угсралтын гүйцэтгэл нь хяналтын')} {num(x.progress.blocks)} {tr('блокийн энгийн дундаж (6-р хэсэг).')}
                      </p>
                    </section>
                    ...
                    <section id="full-3" tabIndex={-1} className={r.section}>
                      ...
                      <p className={r.intro}>
                        ...
                        {/* ⚠️ Багцгүй үед «—-ийг «» багц» гэсэн тасархай өгүүлбэр гаргахгүй (PDF-тэй ижил нөхцөл, 2026-09-17) */}
                        {d.heavyStage && <> {tr('Одоогийн байдлаар төслийн төсвийн')} {pct(d.heavyStage.weight, 1)}{tr('-ийг «')}{tr(d.heavyStage.label)}{tr('» багц эзэлж байгаа тул нийт гүйцэтгэл голчлон түүнээс хамаарч байна.')}</>}
                      </p>
