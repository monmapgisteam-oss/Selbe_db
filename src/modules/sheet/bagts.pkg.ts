...
export const PKGS: Pkg[] = [
   ...
   *
   * ⚠️ `TREES`-Д ТҮЛХҮҮРГҮЙ. Тэдгээрийн шатлал нь `gun` баганаас гарна
   *    (`bagtsSheet`: `expect = tree.length` = 0 тул байрлалын ХАТУУ шалгалт
   *    бүхэлдээ алгасагдана). Багана AGOL дээр нэмэгдсэн ч утга нь эхлээд
   *    хоосон — багц бүрийг НЭГ УДАА нийтлэхэд `FillNew.publish` дүүргэнэ.
   *
