...
/*
  ...
  const publish = useCallback(async () => {
    ...
    try {
      ...
      const stale = tr('Хуудас хооронд нь шинэчлэгдсэн (өөр хэрэглэгч нийтэлсэн) тул засваруудыг шинэ мөрүүдэд тулгаж чадсангүй — нийтлэлийг зогсоов. Ноорог хадгалагдсан хэвээр байгаа тул хуудсыг дахин ачаалж, сэргээгээд Нийтлэнэ үү.');
  ...
  return (
    <div className={st.wrap} ref={wrapRef}>
      <div className={st.toolbar}>
        ...
        {/* ⚠️ СУУРЬ ЖААЗ — зөвхөн МЭДЭЭЛЭЛ. Илгээлт нь энэ архивын агшин
            дээрх ЗӨРҮҮ хэлбэрээр хадгалагддаг тул хэрэглэгч «миний тоо юун
            дээр нэмэгдэж байна» гэдгээ харах ёстой. */}
        {!locked && snapDay && (
          <span
            className={st.muted}
            title={publishedToday
              ? tr('Илгээлт нь ЭНЭ архивын жааз дээрх зөрүү хэлбэрээр хадгалагдана. Энэ жааз өнөөдөр үүссэн.')
              : tr('Илгээлт нь ЭНЭ архивын жааз дээрх зөрүү хэлбэрээр хадгалагдана.')}
          >
            {tr('суурь жааз: {0}', snapDay)}
          </span>
        )}
