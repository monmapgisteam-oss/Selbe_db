...
function KpiStrip({
  ...
  /* ⚠️ 2026-09-25: «Нэгтгэл гүйцэтгэл»-ийн төслийн нийт хувь — шүүлтгүй үед
     индикатор ҮҮНИЙГ харуулна (`kpisOf`-ийн `wbsPct`-ийг үз). Ачаалж
     байхад «…» — 6 шатны тоог түр харуулаад дараа нь солих нь хоёр өөр
     хэмжүүрийг нэг шошгоор анивчуулна. */
  const wbsQ = useAsync(loadNegtgelPct, []);
  const wbsPct = wbsQ.state === 'ready' ? wbsQ.data : null;

  /*
   * ⚠️ `landPct` нь ХАМААРАЛД ЗААВАЛ: 6 шатны нөөц бодолтын (шүүлттэй эсвэл
   * нэгтгэл уншигдаагүй үед) нэг гишүүн нь газар чөлөөлөлтийн явц.
   * Хамааралд оруулаагүй бол газрын тоо ирэхэд индикатор шинэчлэгдэхгүй,
   * гурав дахин бага утга дээр гацна.
   */
  const k = useMemo(() => {
  ...
  /** Шүүлтгүй ба нэгтгэл хараахан ирээгүй — «…» */
  const progWait = k.whole && wbsQ.state === 'loading';
    ...
    <div className={g.kpis}>
      ...
      <Stats cols={3}>
        ...
        {/*
          ...
          */}
        {/* ⚠️ 2026-09-25: шүүлтгүй үед «Нэгтгэл гүйцэтгэл»-ийн төслийн нийт
            (`loadNegtgelPct`); шүүлттэй эсвэл нэгтгэл уншигдаагүй үед 6 шатны
            ӨРТГӨӨР жигнэсэн хувь — шошго нь `progressSrc`-ээр ЯЛГАРНА
            («… (6 шатаар)»). Дашбоардын «Биет гүйцэтгэл (багцаар)» (TASK_SHEET)
            БИШ; «Багц ажил» нь гэрээний МӨРИЙН тоо (74), Дашбоардын «Багц
            (газрын зураг)» (55) биш. `Stat`-д title байхгүй тул нэрэнд. */}
        <Stat
          icon="chart"
          value={progWait ? '…' : k.progress == null ? '—' : pct(k.progress)}
          label={progWait ? tr('Гүйцэтгэлийн хувь') : progressLabel(k.progressSrc)}
        />
