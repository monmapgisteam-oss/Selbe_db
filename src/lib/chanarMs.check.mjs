 ...
 */
{
  ...
  const r1 = review(doc0, { as: 'tuh', who: 'Hyanagch_A', verdict: VERDICT.ok });
  ...
  const r2 = review(
    ...
    { as: 'chanar', who: 'hyanagch_a', verdict: VERDICT.ok },
  );
  ...
  const r3 = review(
    { ...doc0, reviews: r1.reviews },
    { as: 'chanar', who: 'Hyanagch_B', verdict: VERDICT.ok },
  );
  ...
  const r4 = review(
    { ...doc0, reviews: r1.reviews },
    { as: 'tuh', who: 'Hyanagch_B', verdict: VERDICT.ok },
  );
