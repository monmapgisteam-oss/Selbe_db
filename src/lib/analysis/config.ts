 ...
 *
 * ⚠️ Ногоон байгууламж, одоо байгаа барилга, газар чөлөөлөлт дутуу нь
 * «тохиромжтой байдал»-ын үнэлгээнд утгагүй (хүн ам, FAR/BCR, зогсоол зэрэг
 * үзүүлэлт хамаарахгүй) тул тооцоо, эрэмбэ, дундажаас ХАСНА. Газрын зурагт
