 ...
 *
 * ⚠️ 2026-08-24: Дэд бүтцийн ӨРТГИЙН загвар (`negj_une` нэгж үнэ) бүхэлдээ
 * ХАСАГДАВ — зохиомол дата байсан. Энэ модульд одоо мөнгөн дүн ОГТ байхгүй:
 * зөвхөн БНБД-ийн норм, жин, босго үлдэв. Давхаргын тоо, хэмжээ хэрэгтэй бол
 * `usePlanTotals()` сервер тал дээр `outStatistics`-ээр бодчихсон байдаг тул
 ...
 * ГАНЦ тодорхойлолттой бөгөөд энэ файлаас дамжин экспортлогдоно. Энд дахин
 * бичвэл толгойн үзүүлэлт ба «1 га-д ногдох төсөв» хоёр чимээгүй зөрөх өдөр
 * ирнэ.
 */
...
export const SRC = {
  ...
  // ⚠️ ЗӨВХӨН ЗУРАГТ гаргах давхаргын түлхүүр (нэгтгэсэн `data`/35). Анализын
  //    ТООЦОО нь `data.ts`-ийн `GREEN_DATA_URL` (`nogoon_baiguulamj_analysis`
  //    /118 — бүсээр огтлолцуулсан, `RefName_12`-той) дээр явна.
  green: 'nogoon',
  busStops: 'et:2',
  lrtStops: 'et:1',
} as const;
 ...
 * ба каталог уншдаг (онооны тооцоо энэнээс хамаардаггүй — `SuitMap`,
...
/**
 * НОГООН БАЙГУУЛАМЖ — анализын тооцоотой ижил утга харуулах ЗУРГИЙН давхарга.
 *
 ...
 *
 * ⚠️ Тооцоо ба зураг ИЖИЛ ДҮН өгөх ёстой: карт «байгаа ногоон 42 га» гэж
 * бичээд зурагт өөр давхарга гэрэлтвэл хэрэглэгч аль нь худал болохыг шалгах
 * аргагүй болно. ⚠️ Зураг ба тооцоо ТУСДАА үйлчилгээнээс ирдэг болсныг санах
 * хэрэгтэй (зурагт `data`/35 — нэгтгэсэн полигон, атрибутгүй; тооцоонд
 * `nogoon_baiguulamj_analysis`/118 — бүсээр огтолсон 807 хэсэг): эх сурвалжийн
 * аль нэгийг сольвол нөгөөг нь ЗААВАЛ тулгаж шалгана.
 */
 ...
 *
 * ⚠️ `tr()` ХЭРЭГЛЭХГҮЙ (2026-09-25 аудит): `zoneType()` ОРЧУУЛГАГҮЙ каноник
 * нэр буцаадаг тул EN хэлэнд `tr()`-тэй олонлог («Green space…») хэзээ ч
 * таарахгүй — хасагдах бүсүүд оноололд орж 100 («Very good») гарч, эрэмбийг
 * тэргүүлдэг байв. Нэрийг зөвхөн ДЭЛГЭЦЭД гаргахдаа орчуулна
 * (`GREEN_CATEGORIES`-ийн ижил дүрэм). Доорх хоёр олонлогт мөн адил.
 */
 ...
 *
 * ⚠️ Эх сурвалжид (`nogoon_baiguulamj_analysis`/118 — `data.ts`-ийн
 * `GREEN_DATA_URL`) ашиглаж болох ангилал БАЙХГҮЙ: CAD-аас гарсан бүх объект
 * ганц утгатай, бүсийн код нь `RefName_12`-д. Тиймээс задаргаа НЭГ ангилалд
 * нурна — `data.ts` бүх объектод энэ түлхүүрийг оноодог. (Ангилалтай
 * (нийтийн/тусгай/хязгаарлагдмал) хувилбар нь ET-25 давхаргад л байсан;
 ...
 */
/* ⚠️ `tr()`-гүй каноник нэр (2026-09-25) — `r.type`-тэй EN хэлэнд ч таарна */
...
/* ⚠️ ЭДИЙН ЗАСГИЙН ХЭСЭГ БҮХЭЛДЭЭ ХАСАГДАВ:
   · 2026-08-19 `ECON_SCORE` — хаанаас ч ашиглагдахаа больсон;
   · 2026-08-24 ашгийн маржины загвар (нэгж үнэ, барилгын өртөг, ашиг) —
     зохиомол `negj_une` өгөгдөл дээр тогтдог байсан тул бүрмөсөн устав.
   Одоо энэ файлд мөнгөн дүнтэй холбоотой ямар ч тогтмол БАЙХГҮЙ. */
