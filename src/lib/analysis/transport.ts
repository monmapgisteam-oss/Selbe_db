...
/**
 * ⚠️ V/C ХАРЬЦАА ЭНД БАЙХГҮЙ — санаатай.
 *
 * V/C = эрэлт ÷ хүчин чадал; хүчин чадал = эгнээний тоо × 1600 авто/цаг. Замын
 * давхаргад (`et:5`) ЭГНЭЭНИЙ ТОО байхгүй тул хүчин чадлыг бодох боломжгүй.
 *
 * Өмнө нь «хамгийн ачаалалтай зам = 1.0» гэж авч V/C-ийн зэрэглэлийн шошгыг
 * (Бага…Хүчин чадал хэтэрсэн) зээлсэн «Эрэлтийн индекс» дүрслэл байсныг
 * 2026-08-03-нд ХАССАН: тэр нь хүчин чадлын талаар ямар ч мэдээлэлгүй атлаа
 * «хэтэрсэн» гэж БУРУУ уншуулж байв. Эгнээний өгөгдөл ирвэл жинхэнэ V/C-г
 * энд сэргээнэ — томьёо ба босгыг `TRANSPORT_ANALYSIS_HANDOFF.md` §5-д үлдээв.
 */
