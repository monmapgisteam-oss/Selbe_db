...
/** Нэг эгнээний цагийн хүчин чадал (авто/цаг) — lane count байхгүй үеийн default */
export const CAPACITY_PER_LANE = 1600;

export type VCBand = { max: number; label: string; color: string };

/** V/C харьцааны ангилал (эгнээний тоо байгаа үед л) */
export const VC_BANDS: VCBand[] = [
  { max: 0.50, label: 'Бага', color: '#16a34a' },
  { max: 0.75, label: 'Хэвийн', color: '#a3d84a' },
  { max: 0.90, label: 'Өндөр', color: '#f59e0b' },
  { max: 1.00, label: 'Маш өндөр', color: '#ef4444' },
  { max: Infinity, label: 'Хүчин чадал хэтэрсэн', color: '#b91c1c' },
];
