...
export async function loadAnalysis(onProgress: Progress = () => {}): Promise<AnalysisData> {
  ...
  const GREEN_DATA_URL =
    /* ⚠️ 2026-09-17: MUST → monmap `SELBE_ALL_DATA_0917` (ижил дугаар 118). */
    'https://services.arcgis.com/HJzgwvlNIXssnQar/arcgis/rest/services/SELBE_ALL_DATA_0917/FeatureServer/118';
