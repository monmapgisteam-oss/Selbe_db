...
/**
 * ЗУРГААН төлөв, гэхдээ ГУРВАН өнгө.
 *
 * ⚠️ `neutral` · `unknown` · `loading` ГУРВУУЛАА саарал ч утга нь ӨӨР:
 *   · `neutral` — хэмжээний үзүүлэлт («158 га»). Дүгнэх боломжгүй, дүгнэх ч
 *     шаардлагагүй. Өгөгдөл нь БҮРЭН.
 *   · `unknown` — өгөгдөл ИРЭХГҮЙ БОЛСОН (татагдсангүй, эсвэл эх сурвалжид
 *     тэр утга байхгүй). «Сайн» ч биш, «муу» ч биш.
 *   · `loading` — өгөгдөл ЯВЖ БАЙНА, хэдэн секундын дараа ирнэ.
 *
 * ⚠️ 2026-09-06: `loading` ТУСДАА гарч ирэв. Урьд нь ачаалж буй үзүүлэлт
 * бүр `unknown` болж «Өгөгдөл алга» гэж шошголдог байсан тул нүүр хуудас
 * нээгдэх эхний 10–20 секундэд БАРАГ БҮХ мөр «алга» гэж уншигдаж, хэрэглэгч
 * системийг эвдэрсэн гэж үздэг байв. «Хүлээж байна» ба «байхгүй» хоёр нь
 * хэрэглэгчийн хувьд ТЭС ӨӨР мэдээлэл.
 */
...
export const LEVEL_TONE: Record<Level, string> = {
  ...
  neutral: 'var(--ink-3)',
  unknown: 'var(--ink-3)',
  /* ⚠️ Ачаалалт нь ТӨЛӨВ биш ЯВЦ — өнгө нь хамгийн бүдэг, анхаарал татахгүй */
  loading: 'var(--ink-4, var(--ink-3))',
};
...
export const LEVEL_MARK: Record<Level, string> = {
  ...
  neutral: '·',
  unknown: '?',
  /* ⚠️ «?» БИШ: асуултын тэмдэг нь «мэдэхгүй» гэсэн ЭЦСИЙН утга. Ачаалалт нь
     түр төлөв тул гурван цэг — уншигч «дуусаагүй» гэж шууд ойлгоно. */
  loading: '⋯',
};
