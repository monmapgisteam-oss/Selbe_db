 ...
 */
/**
 * БАГЦЫН ГҮЙЦЭТГЭЛИЙН НЭГТГЭЛ — багц бүрийн гүйцэтгэл, эзлэхүүн, төлөвлөгөө
 * ОГНООГООР. Мөр бүр нэг багцын нэг өдрийн бүртгэл.
 *
 ...
 * цорын ганц эх нь энэ. `TASK_SHEET` нь блок бүрийн биет %-ийг өгдөг ч
 * төлөвлөгөө агуулдаггүй.
 *
 * ⚠️ Хүснэгт одоогоор ХООСОН (0 мөр, 2026-08-21). Дуудагч тал ҮРГЭЛЖ хоосныг
 * зөвшөөрөх ёстой — өгөгдөл орж эхэлмэгц ямар ч кодын өөрчлөлтгүй ажиллана.
 *
 * ⚠️ Энэ бол ХҮСНЭГТ (table), давхарга БИШ: геометргүй тул зурагт зурагдахгүй,
 * `LAYERS`-д бүртгэхгүй.
 */
export const PKG_PROGRESS = {
  url: `${HJ}/selbe_bagts_guitsetgel_negtgel/FeatureServer/169`,
  oid: 'OBJECTID',
  fields: {
    /** Бүртгэсэн огноо — багц бүрийн СҮҮЛИЙН мөрийг үүгээр сонгоно */
    date: 'burtgesen_ognoo',
    /** Багцын нэр — `bagtsKey()`-ээр хэвийн болгоно */
    pkg: 'bagts_ner',
    /** Багцын гүйцэтгэл, % */
    actual: 'bagts_guitsetgel_huvi_1',
