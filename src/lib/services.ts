...
export const LAYERS: LayerDef[] = [
  ...
  /* ─────────── Бүс ─────────── */
  {
    ...
    // ⚠️ Зурагт 2 өнгө (чухал ↔ суурь), диаграмд 5 өнгө. `ZONE_MAP_TYPES`-ыг
    //    диаграмд хэрэглэвэл 5 ангилал 2 өнгө болж, аль нь аль болох нь
    //    уншигдахаа болино — тиймээс `chartValues`-аар салгав.
    paint: {
      field: 'TOROL',
      values: ZONE_MAP_TYPES,
      chartValues: ZONE_TYPES,
