...
export type ModuleKey =
  /**
   * Тойм — бусад БҮХ модулийн өгөгдлийг хөндлөн уншиж, АНХААРАЛ ШААРДАХ зүйлийг
   * л гаргана. Өөрийн давхарга, өөрийн өгөгдөлгүй: барилга, чөлөөлөлт, бүс,
   * талбайн хяналтаас тооцоолсон дохио л энд амьдарна.
   *
   * ⚠️ Энэ модуль тоо ДАВТАХГҮЙ. Бусад самбарын үзүүлэлтийг хуулбарлавал нэг
   * агуулга хоёр газар засагдаж, эргээд салж эхэлнэ. Зөвхөн тэдгээрээс ГАРГАЖ
   * авсан дүгнэлт (хугацаа хэтэрсэн, зөрүүтэй, саатсан) гарна.
   */
  | 'overview'
...
export const MODULES: {
  ...
  { key: 'overview', title: 'Тойм', desc: 'Анхаарал шаардах үзүүлэлт ба эрсдэл', icon: 'target', hue: '#0f766e' },
