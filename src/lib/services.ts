...
export const LAYERS: LayerDef[] = [
   ...
   * шинэчлэгдэж тусдаа үйлчилгээ болов (`nogoon_baiguulamj20267031`, 850 объект;
   * нэрэн дэх «20267031» нь үйлчилгээний ӨӨРИЙНХ нь бичиглэл). Хуучин давхаргын
   * `talbai_m2`/`negj_une` талбар ОГТ байхгүй — 9.7 их наядын эргэлзээтэй өртөг
   * загвараас хамт гарсан (`COST_GROUP_OF`-оос мөн хасагдсан). `Layer` талбар нь
   * ганц утгатай («0MoviliarioLu» — CAD-ийн үлдэгдэл) тул хуучин 3 ангиллын facet
   * ба анализын `GREEN_CATEGORIES` задаргаа нэг ангилал болж нурсан. Бүсийн код
   * нь бүсийн давхаргатай ижил бичиглэлтэй `RefName_1`-д (spatial join).
   */
  {
    id: "nogoon",
    n: 2,
    url: `${HJ}/nogoon_baiguulamj20267031/FeatureServer/2`,
