 ...
 *
 * ⚠️ ХОСТ нь `TD`-ийнхтэй ИЖИЛ (services-ap1 · ACqsMOmNLi5wIdIh) тул
...
const CATALOG_REPLACED_HIDDEN: ReadonlySet<string> = new Set([
  "et:7", "et:10", "et:9", "et:11", "et:8", "et:4", "et:18", "et:23", "et:17", "et:16", "et:3", "et:19",
...
export const LAYER_GROUPS: {
  ...
  /* ⚠️ «Цахилгааны шугам» (`power`, `et:124…127`) бүлэг 2026-09-15-нд ХАСАГДАВ —
     ...
     `et:124…127` LayerDef нь `LAYERS`-д хэвээр (`Ersdel.tsx` шууд уншдаг). */
  {
    key: "prep",
...
const CATALOG_DUP_HIDDEN: ReadonlySet<string> = new Set([
  ...
  "source:eh",
  "et:5",
  "pkg:124", "pkg:125", "pkg:126", "pkg:127",
]);
