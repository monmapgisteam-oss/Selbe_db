...
export function whyFlood(fd: FloodData, s: number, idx: number): FloodWhy | null {
  /**
   * ⚠️ `terrain` = ЖИНХЭНЭ DSM (2026-09-21), тооцооны шатаасан ёроол (`bed`)
   * БИШ. Урьд нь ёроол ирдэг байсан тул голын нүд бүр «орчноосоо 2.5 м нам»,
   * шатаалтын ирмэг дээрх нүд 15%+ налуутай гэж гардаг байв — тэр нь рельеф
   * биш, загварчлалын хиймэл засвар. Рельеф, налуу нь хэрэглэгчийн нүдээр
   * харагдах газартай таарах ёстой тул ЭНД `bed`-ийг ХЭЗЭЭ Ч хэрэглэхгүй.
   */
