 ...
 *
 * `true` — санхүү (`CASHFLOW`) ба төслийн явц (`PROJECT_PROGRESS`)
...
const ALL: Dataset[] = [
  ...
  /*
   * ⚠️ `ds:invest` — «Хөрөнгө оруулалт өртөг 20260706» (`INVEST`) хүснэгтийг
   *    АГЕНТААС ЗОРИУДААР ХАССАН (2026.08.13, өгөгдлийн эзэмшигчийн шийдвэр).
   *
   *    ШАЛТГААН: тэр хүснэгтийн өгөгдөл БУРУУ. Агент нь асуултад хамгийн
   *    тохирох эх сурвалжийг өөрөө сонгодог тул каталогт үлдээвэл санхүүгийн
   *    асуултад түүнийг сонгож, буруу дүн албан ёсны хариулт болж гарна.
   *
   *    ⚠️ БУЦААЖ НЭМЭХГҮЙ — эх өгөгдөл нь ArcGIS дээр засагдаж, эзэмшигч
   *    зөвшөөрсний ДАРАА л сэргээнэ.
   *
   *    ⚠️ ПОРТАЛААС ХАСААГҮЙ: `Bagts`, `Dashboard`, `Tsogts`, `invest.ts`
   *    үүнийг хэвээр хэрэглэнэ — тэнд тоог хүн нүдээрээ хараад дүгнэдэг тул
   *    энэ хасалт нь ЗӨВХӨН агентад хамаарна.
   *
   *    Санхүүгийн асуултад `ds:cashflow2` (`Cashflow/106`) үлдсэн — «Цогцолбор»
   *    дашбоардын толгойн тоо мөн эндээс гардаг.
   */
