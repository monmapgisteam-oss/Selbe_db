...
const TAGGUI_ZOVSHOOROGDSON = new Map([
  ...
  ['src/lib/gdash.ts:loadBuildPkgs',
    'Барилгын блокийн давхаргын БАГЦ утгууд (data/112) — чартаас газрын зураг '
    + 'руу холбоход л хэрэглэгддэг ТОГТМОЛ жагсаалт (7 багц). Портал тэр '
    + 'хүснэгтэд ОГТ бичдэггүй тул автобусын түлхүүр байхгүй.'],
