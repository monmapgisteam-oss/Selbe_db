...
const BICHEED_DUUDAGCH_HUCHINGUI = new Map([
  ...
  ['src/lib/ajilBatlah.ts',
    ...
    + 'хөтөлнө; батлагдсан мөрийг `Bagts_*` руу нэмэх ажил нь дуудагч '
    + 'талд (`FillNew` → `applyUpdates`) явагддаг тул кэшийг ТЭР зам '
    + 'хүчингүй болгоно (2026-09-22). `obyemBatlah.ts`-тэй ЯГ ИЖИЛ шалтгаан.'],
