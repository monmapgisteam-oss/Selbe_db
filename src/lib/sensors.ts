...
/**
 * IoT МЭДРЭГЧ — Mononet-ээс ArcGIS руу ингест хийгддэг таван FeatureServer.
 * Мэдрэгч тус бүр НЭГ төхөөрөмжтэй; давхарга нь мөр тутамд геометрээ давтдаг
 * (телеметрийн хүснэгт биш, цэгийн давхарга).
 *
 * ⚠️ ДАВТАМЖ (2026-08-26-нд амьд хэмжсэн, `tools/iot-verify2.mjs`):
 * ЗАДАРСАН заалтын медиан алхам нь дөрвөн мэдрэгчид ≈60 МИНУТ, усны тоолуурт
 * ≈6 ЦАГ. Урьд нь «15 минут тутам» гэж бичсэн байсан нь БУРУУ байв — түүхий
 * мөр нь багцаар (нэг тэмдэгт цагт хэд хэдэн мөр) ирдэг тул тэр тоо мөрийн
 * урсгалыг ч зөв тодорхойлдоггүй.
 *
...
export type Metric = {
   ...
   * заалтын зөрүүг авна: алхам жигд бус, алдагдсан заалттай байсан ч хоногийн
...
export type SensorDef = {
   ...
   *
   * ⚠️ ЗӨВХӨН хүнд харуулах зорилготой — кодод тааруулахад ХЭРЭГЛЭХГҮЙ.
   * ⚠️ 2026-08-26-нд амьд шалгав (`tools/iot-verify2.mjs`): мэдрэгч бүр ЯГ НЭГ
   * төхөөрөмжтэй. Урьд нь усны тоолуурыг «ОЛОН төхөөрөмжтэй, 825-аар эхэлсэн»
   * гэж бичсэн байсан нь БУРУУ байв — тэнд ч ганц төхөөрөмж (8254812512001104).
   */
  devEui: string;
  /**
 ...
 * Оронд нь эрэмбэлээд ХАНГАЛТТАЙ мөр татаад клиент дээр огтолно.
 *
 * ⚠️ `limit` нь ЗАДАРСАН заалтын бодит алхам (≈60 мин) дээр биш, ТҮҮХИЙ мөрийн
 * урсгал дээр тооцоологдсон: түүхий мөр багцаар ирдэг тул хугацааны нэгжид
 * ногдох мөр нь заалтын тооноос хамаагүй их. Нөөцтэй авсан — хүрээ дүүрэхгүй
 * бол цуваа чимээгүй тасарна.
 */
 ...
 * бодно. Богино зурваст налуу нь чимээнээс тэсрэх (хэдхэн минутад 0.1°
 * хэлбэлзэхэд «цагт хэдэн градус» гэж гарна) тул таамаг утгагүй болно.
 */
 ...
 * «шинэхэн» гэж зарладаг байлаа. Портал руу буцаж ирэхэд ч дахин татдаггүй.
