 ...
 * `HO_guitsetgel_arcgis_csv` 36 багана) нь урьд нь шүүлтгүй байв. Хэрэглэгчийн хүсэлт
 * (2026-09-01): багц · он · төрлөөр, мөн БАГАНА БҮРЭЭР шүүх, багцаар бүлэглэн
 * харах.
 *
 * ⚠️ Бүх мөр аль хэдийн санах ойд байдаг (76 ба 45 мөр — `loadFinRegister`)
 ...
 *
 * ⚠️ 2026-09-09: `IPC_LOG` (`ipc_0813/172`, ТЕСТ өгөгдөл) → `HO_IPC`
 *    (`HO_guitsetgel_arcgis_csv/196`). Хуучинд «Жил» ТАЛБАР БАЙХГҮЙ байсан тул
 *    `IPC09` «Хамрах хугацаа: эхлэх»-ийн жилээр гаргаж, шошгыг «Он (хамрах
 *    хугацаа)» гэж тайлбарлах шаардлагатай байв. Шинэ эхэд ЖИНХЭНЭ оны талбар
 *    (`on_`, 43/45) БИЙ — ердийн «Он» болов.
 */
export const FIN_FACETS: Record<'CASHFLOW_NEW' | 'HO_IPC', Facet[]> = {
  /*
  ...
  /*
   * ⚠️ Талбарын нэр нь `IPC0xx` код БИШ, утгатай латин галиг.
   * ⚠️ ХОЁР ГРЕЙН нэг хүснэгтэд: `bagts` нь ГЭРЭЭНИЙ түвшний (мөрд
   *    давтагдана), `on_`/`tulult_turul` нь ТӨЛБӨРИЙН түвшний. Шүүлтэд энэ
