 ...
 *      цэвэр дүн `null` (`services.ipcNet` нь 0 болгодог — түүнийг энд
 *      ХЭРЭГЛЭХГҮЙ байгаагийн шалтгаан).
...
/* ── 6. IPC — суутгал · цэвэр · шилжүүлсэн null-ухаантай ── */
{
  ...
  assert.equal(netOrNull(empty), null, 'дүнгүй актын цэвэр нь null — ipcNet-ийн 0-ээс ЯЛГААТАЙ');
