...
async function loadFinanceRaw(): Promise<ReportExtra['finance']> {
   ...
   *    багцын нийлбэр 316,587,724,910 ₮ (316.59 тэрбум), жинхэнэ нийт
   *    318,422,789,981 ₮ (318.42 тэрбум).
   *    ⚠️ 2026-09-04: эдгээр нь тэр өдрийн АМЬД хэмжилт (ipc_0813/172, 59 мөр).
   *    `ipcNet` нь `null` буцаадаг болохоос ӨМНӨ энд «314.5 / 316.35 тэрбум»
   *    гэж бичигдсэн байв — доорх `null` алгасалт нийт олголтыг 2,072,616,655 ₮
   *    -ээр (I30 актын IPC18 хоосон, IPC20 суутгал) НЭМЭГДҮҮЛСЭН тул хоёр
   *    туйлын тоо шинэчлэгдэв. Зөрүү нь ХЭВЭЭР 1,835,065,071 ₮. Дэлгэцийн
   *    тоог тайлбартай тулгах хүн «зөрөв» гэж эндүүрэхээс сэргийлж дараагийн
   *    шинэчлэлд огноог нь ЗААВАЛ бич. Тайлан ·
   ...
   */
  /*
   * ⚠️ 2026-09-04: `ipcNet()` нь `number | null` болов (services.ts) — дүн
   *    бүртгэгдээгүй акт (IPC18 хоосон, 59-өөс 38 мөр) одоо `null` буцаана.
   *    Өмнө нь `nz()` тэднийг 0 болгодог байсан тул суутгал (IPC20) нь
   *    цэвэр дүнгүйгээр хасагдаж, нэг актад −2,072,616,655 ₮ гэсэн ХУУРАМЧ
   *    сөрөг олголт үүсгэж, төслийн нийтийг тэр хэмжээгээр дутуу үзүүлж байв.
   *    ЭНД `?? 0` БИЧИХГҮЙ — «хэмжигдээгүй» ба «тэг олголт» хоёр өөр. Тиймээс
   *    `null` мөрийг НИЙЛБЭРЭЭС АЛГАСНА (тоологдох мөрийн тоо багасна, дүн
   *    гуйвахгүй). Эргэж гарах хувилбар: хэн нэг нь `a + (ipcNet(r) ?? 0)`
   *    гэж «хялбарчилвал» дүн ижил хэвээр ч санаа нь дахин будлиантаж,
   *    дараагийн хүн 0-г бодит олголт гэж уншина.
   */
