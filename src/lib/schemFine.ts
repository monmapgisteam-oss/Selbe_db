...
/**
 * БҮЛГИЙН ҮНДСЭН КАРТ — тухайн бүлгийн анхааруулга хаана буух вэ.
 *
 * ⚠️ ЯАГААД ХЭРЭГТЭЙ (2026-09-02, хэрэглэгч: «процессын үед ямар alert байгааг
 * харуулна»). Анхааруулга нь `schemDetail.ts`-д БҮЛГЭЭР (`SchemId`) бодогддог
 * бөгөөд нарийн схемд нэг бүлэг 2–5 картад задардаг. Бүлгийн бүх анхааруулгыг
 * тэр бүх картад давхардуулж тавибал «зөвшөөрсөн» гэсэн ногоон карт дээр
 * «төлөв танигдсангүй» гэсэн улаан дохио гарч, аль карт нь жинхэнэ асуудалтай
 * болох нь мэдэгдэхээ болино.
 *
 * Тиймээс анхааруулга бүр `Issue.at`-аар ЯГ өөрийн картаа заана; заагаагүй
 * (бүлэг бүхэлдээ хамаарах — жишээ нь «үйлчилгээ татагдсангүй») нь энэ үндсэн
 * картад буна.
 *
 * ⚠️ Ерөнхий схемд (10 карт) энэ зураглал ХЭРЭГЛЭГДЭХГҮЙ: тэнд бүлэг бүр ганц
 * карттай тул бүх анхааруулга шууд өөрийн зангилаанд харагдана.
 */
export const GROUP_ROOT: Record<SchemId, FineId> = {
  tolovlolt: 'plan',
  zovshoorol: 'zov',
  gazar: 'gaz',
  huvaari: 'huv',
  barilga: 'bar',
  /* Буцаалт нь ажлыг ГҮЙЦЭТГЭГЧ рүү эргүүлдэг тул хяналтын бүлгийн үндэс тэр */
  hyanalt: 'hyCo',
  habea: 'hab',
  ersdel: 'ers',
  sankhuu: 'finBudget',
 ...
 *
 * ⚠️ h/gapY нь КАРТЫН БОЛОМЖИТ ДЭЭД ӨНДӨРТ тааруулагдсан (2026-09-02): карт
 * бүр үр дүнгийн мөр + анхааруулгатай болсноор бодит өндөр нь 104-өөс хэтэрч,
 * «Зогссон блок» доорх «Хүн хүч, техник»-тэй ДАВХАЦДАГ байв. Дээд өндөр =
 * pad 19 + толгой 20 + тодорхойлолт 3 мөр ≈42 + үр дүн 24 + анхааруулга ≤49
 * ≈ 154px < мөрийн алхам (130+30=160). Агуулга нэмэх бол ЭНЭ тооцоог шинэчил.
 */
export const GEO_FINE: Geo = { w: 196, h: 130, gapX: 40, gapY: 30, pad: 28 };
