...
/**
 * Төгрөг — ҮРГЭЛЖ БҮТЭН, мянгатын таслалтай: 2660000000000 → «2,660,000,000,000 ₮»
 *
 * ⚠️ 2026-09-01. Урьд нь «2.66 их наяд ₮» гэж товчилдог, дээр нь «2.66 их н. ₮»
 *    гэсэн бүр богино хувилбар (`mntAbbr`) байсан (2026-08-21-ний хүсэлт — KPI-ийн
 *    нарийхан нүдэнд бүтэн үг хоёр мөр болдог байв). Хэрэглэгч энэ шийдвэрийг
 *    БУЦААЖ дарсан: «бүх мөнгөн дүн бүтэн харагдана, мянган орангийн таслалтай».
 *    Товчлолыг БҮҮ сэргээ — портал даяар тарсан 7 биет хуулбарыг энэ рүү
 *    нэгтгэсэн тул энд буцаавал харагдацууд өөр хоорондоо зөрнө. Багтахгүй бол
 *    фонт/баганы өргөнөөр шийднэ, ТООГ богиносгохгүй.
 *
 * ⚠️ `0` нь `'—'` — «0 ₮» гэж бичвэл «огт олгоогүй» гэж ХУДАЛ уншигдана
 *    (`PkgFin`, `PkgProg`-ийн тайлбар). `num`-аас ялгаатай энэ зан заавал үлдэнэ.
 */
