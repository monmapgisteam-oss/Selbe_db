...
const HomeBoard = dynamic(() => import('./HomeBoard').then((m) => m.HomeBoard), { ssr: false });
  ...
  return (
    <div className={s.home}>
      ...
      <main className={s.board}>
        ...
        {/*
          * ⚠️ 2026-09-06 (хэрэглэгчийн шийдвэр): хуучин `ExecKpi` самбар —
          *    таван ангилалд эгнүүлсэн 28 мөр — БҮРМӨСӨН ХАСАГДАВ. Тэр нь
          *    ойлгомжгүй байв: мөр бүр «шошго · тоо · тайлбар · түвшин» гэсэн
          *    дөрвөн багана боловч тоонууд ХООРОНДОО ХАМААРАЛГҮЙ, дараалал нь
          *    зөвхөн өнгөөр эрэмбэлэгддэг тул «юу юуг үүсгэж байна» гэдэг
          *    хэзээ ч харагддаггүй байлаа.
          *
          *    Одоо үзүүлэлт бүр ҮЙЛ АЖИЛЛАГААНЫ СХЕМИЙН зангилаандаа сууна —
          *    тоо байрандаа наалдаж, дээд урсгалын улаан нь доод урсгалынхаа
          *    улааныг тайлбарлана. Задаргаа нь `HomeBoard.tsx`-ийн толгойд.
          */}
        <HomeBoard onView={onEnterView} />
      </main>
      )}
