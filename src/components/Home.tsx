...
/* ⚠️ dynamic (2026-08-21 гүйцэтгэлийн аудит): самбар нь өөрийн ачаалагчдыг
   дагуулж ирдэг тул статик импортоор нэвтрэх/нүүр хуудасны эхний chunk-д
   ордог байв. Зөвхөн супер хэрэглэгчид л харагддаг хэсэг — хэрэгтэй үед нь татна.
...
export function Home({
  ...
  isSuper?: boolean;
  /**
   * Удирдлагын самбар харагдах эсэх.
   *
   * ⚠️ `isSuper`-ЭЭС ТУСДАА (2026-09-15-ны хэрэглээний аудит): самбар нь
   *    ЗӨВХӨН УНШИХ бөгөөд бичих үйлдэлгүй тул «бүх харагдац» эрхтэй
   *    удирдлагын хүнд нээгддэг. Урьд нь `isSuper` дангаар хаадаг байсан тул
   *    харах эрх олгогдсон дарга нэвтэрвэл навигацийн зурвастай ХООСОН хуудас
   *    хардаг байв. `isSuper` нь админ товчийг хаасан ХЭВЭЭР.
   *
   * ⚠️ Өгөөгүй бол хуучин зан төлөв (`isSuper`) — дуудагч заавал шинэчлэх
   *    шаардлагагүй.
   */
  ...
  return (
    <div className={s.home}>
      ...
      {/* ── Дашбоард — супер БА «бүх харагдац» эрхтэй удирдлага (2026-08-21,
             хамрах хүрээ 2026-09-15-нд өргөжсөн — `boardAllowed`-ийн ⚠️) ── */}
      {(boardAllowed ?? isSuper) && (
      <main className={s.board}>
        ...
        {/*
          * ⚠️ 2026-09-06 (хэрэглэгчийн шийдвэр, нэг өдөрт ХОЁР удаа солигдов):
          *    өглөө `ExecKpi` (таван ангиллын 28 мөр) → схем-самбар
          *    (`HomeBoard`), орой нь CEO өөрөө 14 үзүүлэлтээ нэрлэж «хуучин
          *    дизайныг бүрэн устгаж болно» гэв. Одоо `CeoBoard` — тэр
